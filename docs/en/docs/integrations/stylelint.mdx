...
<PackageManagerTabs
  command={{
    ...
    bun: "bun x extension@latest create my-extension --template=new-stylelint",
  }}
/>
...
<PackageManagerTabs
  command={{
    ...
    bun: "bun x install -D stylelint stylelint-config-standard",
  }}
/>
...
<PackageManagerTabs
  command={{
    ...
    bun: "bun x install -D stylelint-scss stylelint-less",
  }}
/>
...
<PackageManagerTabs
  command={{
    ...
    bun: "bun x install -D stylelint-prettier prettier",
  }}
/>
