...
<PackageManagerTabs
  command={{
    ...
    bun: "extension build [extension-path | extension-url] [options]",
  }}
/>
...
<PackageManagerTabs
  command={{
    ...
    bun: "extension build ./my-extension --browser=edge,chrome --zip --zipFilename=my-extension.zip",
  }}
/>
...
<PackageManagerTabs
  command={{
    ...
    bun: "extension build ./my-extension --browser=chrome --silent",
  }}
/>
...
<PackageManagerTabs
  command={{
    ...
    bun: "extension build ./my-extension --browser=all --polyfill",
  }}
/>
