...
<PackageManagerTabs
  command={{
    ...
    bun: "bun x extension@latest create my-extension --template=new-sass",
  }}
/>
...
<PackageManagerTabs
  command={{
    ...
    bun: "bun x extension@latest create my-extension --template=new-sass-modules",
  }}
/>
