...
<PackageManagerTabs
  command={{
    ...
    bun: "extension dev [extension-path | extension-url] [options]",
  }}
/>
...
<PackageManagerTabs
  command={{
    ...
    bun: "extension dev ./my-extension",
  }}
/>
...
<PackageManagerTabs
  command={{
    ...
    bun: "extension dev https://example.com/my-extension",
  }}
/>
...
<PackageManagerTabs
  command={{
    ...
    bun: "extension dev ./my-extension --browser firefox",
  }}
/>
...
<PackageManagerTabs
  command={{
    ...
    bun: "extension dev ./my-extension --browser all",
  }}
/>
...
<PackageManagerTabs
  command={{
    ...
    bun: "extension dev ./my-extension --gecko-binary /path/to/brave",
  }}
/>
