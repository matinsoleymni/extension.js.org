...
<PackageManagerTabs
  command={{
    ...
    bun: "bun x extension@latest create <extension-name|extension-path> [options]",
  }}
/>
...
<PackageManagerTabs
  command={{
    ...
    bun: "bun x extension@latest create my-extension --template=react",
  }}
/>
...
<PackageManagerTabs
  command={{
    ...
    bun: "extension create path/to/my-extension --template=react",
  }}
/>
